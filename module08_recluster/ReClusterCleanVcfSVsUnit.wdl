...
import "ShardedCluster.wdl" as sharded_cluster
...
workflow ReClusterCleanVcfSVs {
    ...
    call sharded_cluster.ShardedCluster as ShardedCluster {
        input:
    ...
    output{
        File reclustered_SV = ShardedCluster.clustered_vcf
        File reclustered_SV_idx = ShardedCluster.clustered_vcf_idx
    }
}
