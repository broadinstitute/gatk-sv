...
train_site_path = './trainin_sets/per_chr_anno/'
site_feature = readin_site_features(train_site_path)

# read in per-sample features 
train_sample_path = './trainin_sets/per_sample_anno/'
...
LD_SVID_afr = read.table('trainin_sets/LD_training/gnomadV2_vs_V3.AFR.SVID')
LD_SVID_eur = read.table('trainin_sets/LD_training/gnomadV2_vs_V3.EUR.SVID')
LD_SVID = data.frame(unique(rbind(LD_SVID_afr, LD_SVID_eur)[,1]))

#readin training set for large CNVs on SSC samples
ssc_training = readin_lg_cnv_training('trainin_sets/array_training/')
...
# QC CV results:
r1=read.table('trainin_sets/cross_validation/cv_round.1.tsv', header = T)
r2=read.table('trainin_sets/cross_validation/cv_round.2.tsv', header = T)
r3=read.table('trainin_sets/cross_validation/cv_round.3.tsv', header = T)
r4=read.table('trainin_sets/cross_validation/cv_round.4.tsv', header = T)
r5=read.table('trainin_sets/cross_validation/cv_round.5.tsv', header = T)

pdf('boost_qc_plots/count_SVs_by_bs.CV_all_samples.pdf')
plot_SVCounts_by_bs_score_all_CV(training_data, r1,r2,r3,r4,r5)
dev.off()

pdf('boost_qc_plots/FDR_vs_bs_cff.CV_all.pdf')
plot_fdr_vs_BScff(training_data, r1,r2,r3,r4,r5)
dev.off()

for(cff in c(-2,-1,0)){
  print(cff)
  png(paste('boost_qc_plots/upsetplot.CV_all_rounds.bs_',cff,'.png',sep=''))
  plot_upset_all_CV(training_data, r1,r2,r3,r4,r5, cff)
  dev.off()
}
for(svtype in c('DEL','DUP','INS','INV')){
  print(svtype)
  png(paste('boost_qc_plots/upsetplot.CV_all_rounds.bs_-1.',svtype,'.png',sep=''))
  plot_upset_all_CV(training_data[training_data$SVTYPE.x==svtype,], r1,r2,r3,r4,r5, -1)
  dev.off()
}
png(paste('boost_qc_plots/upsetplot.CV_all_rounds.bs_-1.round.1.png',sep=''))
plot_upset_each_CV(training_data, r1, -1)
dev.off()
png(paste('boost_qc_plots/upsetplot.CV_all_rounds.bs_-1.round.2.png',sep=''))
plot_upset_each_CV(training_data, r2, -1)
dev.off()
png(paste('boost_qc_plots/upsetplot.CV_all_rounds.bs_-1.round.3.png',sep=''))
plot_upset_each_CV(training_data, r3, -1)
dev.off()
png(paste('boost_qc_plots/upsetplot.CV_all_rounds.bs_-1.round.4.png',sep=''))
plot_upset_each_CV(training_data, r4, -1)
dev.off()
png(paste('boost_qc_plots/upsetplot.CV_all_rounds.bs_-1.round.5.png',sep=''))
...
save(bgm_models,file = 'trainin_sets/lgb_models/bgm_model.all_svtypes.rdata')
saveRDS.lgb.Booster(bgm_models[[1]], file = 'trainin_sets/lgb_models/bgm_model.DEL_s1_under250bp.rds', raw=TRUE)
saveRDS.lgb.Booster(bgm_models[[2]], file = 'trainin_sets/lgb_models/bgm_model.DUP_s1_under250bp.rds', raw=TRUE)
saveRDS.lgb.Booster(bgm_models[[3]], file = 'trainin_sets/lgb_models/bgm_model.DEL_s2_250bpto1Kb.rds', raw=TRUE)
saveRDS.lgb.Booster(bgm_models[[4]], file = 'trainin_sets/lgb_models/bgm_model.DUP_s2_250bpto1Kb.rds', raw=TRUE)
saveRDS.lgb.Booster(bgm_models[[5]], file = 'trainin_sets/lgb_models/bgm_model.DEL_s3_1to5Kb.rds', raw=TRUE)
saveRDS.lgb.Booster(bgm_models[[6]], file = 'trainin_sets/lgb_models/bgm_model.DUP_s3_1to5Kb.rds', raw=TRUE)
saveRDS.lgb.Booster(bgm_models[[7]], file = 'trainin_sets/lgb_models/bgm_model.DEL_s4_5to50Kb.rds', raw=TRUE)
saveRDS.lgb.Booster(bgm_models[[8]], file = 'trainin_sets/lgb_models/bgm_model.DUP_s4_5to50Kb.rds', raw=TRUE)
saveRDS.lgb.Booster(bgm_models[[9]], file = 'trainin_sets/lgb_models/bgm_model.DEL_s5_over50Kb.rds', raw=TRUE)
saveRDS.lgb.Booster(bgm_models[[10]], file = 'trainin_sets/lgb_models/bgm_model.DUP_s5_over50Kb.rds', raw=TRUE)
saveRDS.lgb.Booster(bgm_models[[11]], file = 'trainin_sets/lgb_models/bgm_model.INS.rds', raw=TRUE)
saveRDS.lgb.Booster(bgm_models[[12]], file = 'trainin_sets/lgb_models/bgm_model.ALU.rds', raw=TRUE)
saveRDS.lgb.Booster(bgm_models[[13]], file = 'trainin_sets/lgb_models/bgm_model.MEI.rds', raw=TRUE)
