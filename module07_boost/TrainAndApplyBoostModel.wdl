...
workflow TrainAndApplyBoostModel{
    input{
    ...
    scatter (i in range(length(input_folders))){
        call ApplyBoostFilterV2 as apply_boost_filter{
            input:
...
task ApplyBoostFilterV2{
    ...
    command <<<
        ...
        Rscript /src/Boost_Step1and2.Train_and_Apply_Boost.R \
