...
|`File`|`ploidy_plots`|Tarball of contig ploidy plots, editable PDF sidecars, and the static ploidy report. After extraction, open `plot/report/index.html`; `plot/plot_manifest.tsv` lists every linked figure and table.|
