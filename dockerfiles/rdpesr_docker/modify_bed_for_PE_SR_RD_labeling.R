...
dat2[,2] = format(dat2[,2], scientific = FALSE)
dat2[,3] = format(dat2[,3], scientific = FALSE)
dat3[,2] = format(dat3[,2], scientific = FALSE)
dat3[,3] = format(dat3[,3], scientific = FALSE)
dat4[,2] = format(dat4[,2], scientific = FALSE)
dat4[,3] = format(dat4[,3], scientific = FALSE)
dat5[,2] = format(dat5[,2], scientific = FALSE)
dat5[,3] = format(dat5[,3], scientific = FALSE)
