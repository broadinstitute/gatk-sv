...
scripts/inputs/build_inputs.py ${BASE_DIR}/input_values ${BASE_DIR}/test_input_templates ${BASE_DIR}/test_inputs_single_sample -a '{ "test_single_sample" : "test_single_sample_NA19240", "ref_panel" : "ref_panel_v1b" }'