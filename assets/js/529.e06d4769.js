...
const findOrCreateNode = (ID) => {
  ID = mermaid_b5860b54.e.sanitizeText(ID, (0,mermaid_b5860b54.c)());
  if (!nodesMap[ID]) {
...
const db = {
  nodesMap,
  getConfig: () => (0,mermaid_b5860b54.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,mermaid_b5860b54.c)();
  const defaultSankeyConfig = mermaid_b5860b54.K.sankey;
  let sandboxElement;
