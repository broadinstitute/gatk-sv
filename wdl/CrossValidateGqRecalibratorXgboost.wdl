...
import "TrainGqRecalibratorXgboost.wdl" as TrainGqRecalibratorXgboost
import "RecalibrateGqXgboost.wdl" as RecalibrateGqXgboost
import "BenchmarkGqFilterXgboost.wdl" as BenchmarkGqFilterXgboost
import "PickleVcfProperties.wdl" as PickleVcfProperties
import "Utils.wdl" as Utils

workflow CrossValidateGqRecalibratorXgboost {
    input {
        File train_vcf
    ...
    call TrainGqRecalibratorXgboost.TrainGqRecalibratorXgboost {
        input:
    ...
    call RecalibrateGqXgboost.RecalibrateGqXgboost as DirectGqRecalibrator {
        input:
            vcf=train_vcf_,
            vcf_index=train_vcf_index_,
            genome_tracks=genome_tracks,
            gq_recalibrator_model_file=TrainGqRecalibratorXgboost.output_gq_recalibrator_model_file,
            standardize_vcf=false,
    ...
    scatter(fold in range(length(cross_validation_vcfs_.train_vcfs))) {
        call TrainGqRecalibratorXgboost.TrainGqRecalibratorXgboost as CrossTrainGqRecalibrator {
            input:
        ...
        call RecalibrateGqXgboost.RecalibrateGqXgboost as CrossGqRecalibrator {
            input:
    ...
    File truth_overlap_info_ = select_first([truth_json, TrainGqRecalibratorXgboost.truth_overlap_info])
    call BenchmarkGqFilterXgboost.BenchmarkGqFilterXgboost {
        input:
    ...
    output {
        File clean_vcf = TrainGqRecalibratorXgboost.clean_vcf
        File clean_vcf_index = TrainGqRecalibratorXgboost.clean_vcf_index
        File truth_overlap_info = truth_overlap_info_
        Array[File] output_optimal_overlap_cutoffs = TrainGqRecalibratorXgboost.output_optimal_overlap_cutoffs
        File output_gq_recalibrator_model_file = TrainGqRecalibratorXgboost.output_gq_recalibrator_model_file
        ...
        File benchmark_figure = BenchmarkGqFilterXgboost.benchmark_figure
        File variant_properties = BenchmarkGqFilterXgboost.variant_properties
        File pickled_original_scores = BenchmarkGqFilterXgboost.pickled_original_scores
        Array[File] pickled_comparison_scores = BenchmarkGqFilterXgboost.pickled_comparison_scores
