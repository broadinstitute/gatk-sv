...
workflow GangSTRScatter {
  ...
  output {
    Array[File] output_vcfs = select_all(GangSTR.output_vcf)
    Array[File] samples_stats = select_all(GangSTR.sample_stats)
    Array[File] insdatas = select_all(GangSTR.insdata)
  }
}