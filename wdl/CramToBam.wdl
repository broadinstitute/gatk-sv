...
workflow CramToBam {
  ...
  output {
    File bam_file = select_first([RunCramToBamRequesterPays.bam_file, RunCramToBam.bam_file, RunCramToBamCredentials.bam_file])
    File bam_index = select_first([RunCramToBamRequesterPays.bam_index, RunCramToBam.bam_index, RunCramToBamCredentials.bam_index])
  }
}
...
# This version provides service account credentials to access and localize the cram
task RunCramToBamCredentials {
  input {
    String cram_file
    File reference_fasta
    File? reference_index
