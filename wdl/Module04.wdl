  ...
  if (run_module_metrics_) {
    call metrics.Module04Metrics {
      input:
        ...
        cutoffs_pesr_pesr = GenotypePESRPart1.RD_pesr_sepcutoff,
        cutoffs_pesr_depth = GenotypePESRPart1.RD_depth_sepcutoff,
        cutoffs_depth_pesr = GenotypeDepthPart1.RD_pesr_sepcutoff,
        cutoffs_depth_depth = GenotypeDepthPart1.RD_depth_sepcutoff,
