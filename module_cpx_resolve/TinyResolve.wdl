...
workflow TinyResolve {
  ...
  output {
    ...
    Array[File] unresolve_manta_vcf = flatten(ResolveManta.unresolve_vcf)
  }
}
...
task ResolveManta {
  ...
  output {
    Array[File] tloc_vcf = glob("tloc_*.manta.complex.vcf.gz")
    Array[File] unresolve_vcf = glob("tloc_*.manta.unresolved.vcf.gz")
  }
