...
def __parse_arguments(argv: list[str]) -> argparse.Namespace:
    ...
    # noinspection PyTypeChecker
    parser.add_argument("--combine-strategy", "-c", type=str,
                        choices=ConfidentVariantsCombineStrategy.choices,
                        default=Default.combine_strategy.value,
...
def main(argv: Optional[list[str]] = None) -> None:
    ...
    combine_truth_jsons(
        ...
        combine_strategy=ConfidentVariantsCombineStrategy(arguments.combine_strategy)
    )
