...
def create_image_dict(image_list):
    ...
    return region_to_image_dict, batches


def write_reports(base_path, region_to_image_dict, region_names, batches):
...
def main(argv: Optional[List[Text]] = None):
    ...
    region_to_image_dict, batches = create_image_dict(image_list=image_list)
    write_reports(base_path=args.out, region_to_image_dict=region_to_image_dict,
                  region_names=region_names, batches=batches)
