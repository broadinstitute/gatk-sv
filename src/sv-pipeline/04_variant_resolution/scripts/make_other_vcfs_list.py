...
def make_other_vcfs_list(namespace, workspace, batches):
    ...
    for batch in batches:
        ...
        other_pesr_vcfs = [o['attributes']['filtered_pesr_vcf'] for o in others]
        other_depth_vcfs = [o['attributes']['filtered_depth_vcf'] for o in others]
...
def main():
    ...
    vcf_lists = list(make_other_vcfs_list(args.project, args.workspace, batches))
