...
inputmales   = args.inputfolder+'/'+'.'.join([args.batch,  args.source, args.chrom,'males.metrics'])
inputfemales = args.inputfolder+'/'+'.'.join([args.batch,  args.source, args.chrom, 'females.metrics'])
output       = args.outputfolder+'/'+'.'.join([args.batch, args.source, args.chrom, 'metrics'])
