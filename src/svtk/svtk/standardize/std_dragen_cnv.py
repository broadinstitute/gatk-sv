...
class DragenCnvStandardizer(VCFStandardizer):
    # Dragen CNV is a depth-based caller; tag calls as 'depth' regardless of
    # the 'dragen_cnv' source name used on the command line.
    ALGORITHM = 'depth'
    ...
    def standardize_info(self, std_rec, raw_rec):
        ...
        # Define ALGORITHMS
        std_rec.info['ALGORITHMS'] = [self.ALGORITHM]
