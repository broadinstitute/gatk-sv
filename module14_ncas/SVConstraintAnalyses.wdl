...
task SVsVsGenesPart2{
    ...
    String vs_3_prime_utr_base = basename(vs_3_prime_utr)
    String vs_5_prime_utr_base = basename(vs_5_prime_utr)
    String vs_inside_exons_base = basename(vs_inside_exons)
    String vs_inside_introns_base = basename(vs_inside_introns)
    String vs_intact_exon_overlap_base = basename(vs_intact_exon_overlap)
    String vs_partial_exon_overlap_base = basename(vs_partial_exon_overlap)
    String vs_tss_transcripts_overlap_base = basename(vs_tss_transcripts_overlap)
    String vs_partial_transcripts_overlap_base = basename(vs_partial_transcripts_overlap)
    String vs_whole_transcript_overlap_base = basename(vs_whole_transcript_overlap)
    ...
    command <<<
        ...
        Rscript ./src/reorganize_SVID_vs_gene.R -g gene_permu/r3.gencode.v39.ensembl.105.transcript.permu_~{permu}.bed.gz -i ~{vs_whole_transcript_overlap} -o ~{vs_whole_transcript_overlap_base}.reorganized
        Rscript ./src/reorganize_SVID_vs_gene.R -g gene_permu/r3.gencode.v39.ensembl.105.transcript.permu_~{permu}.bed.gz -i ~{vs_3_prime_utr}  -o ~{vs_3_prime_utr_base}.reorganized
        Rscript ./src/reorganize_SVID_vs_gene.R -g gene_permu/r3.gencode.v39.ensembl.105.transcript.permu_~{permu}.bed.gz -i ~{vs_5_prime_utr}  -o ~{vs_5_prime_utr_base}.reorganized
        Rscript ./src/reorganize_SVID_vs_gene.R -g gene_permu/r3.gencode.v39.ensembl.105.transcript.permu_~{permu}.bed.gz -i ~{vs_intact_exon_overlap}   -o ~{vs_intact_exon_overlap_base}.reorganized
        Rscript ./src/reorganize_SVID_vs_gene.R -g gene_permu/r3.gencode.v39.ensembl.105.transcript.permu_~{permu}.bed.gz -i ~{vs_partial_exon_overlap}  -o ~{vs_partial_exon_overlap_base}.reorganized
        Rscript ./src/reorganize_SVID_vs_gene.R -g gene_permu/r3.gencode.v39.ensembl.105.transcript.permu_~{permu}.bed.gz -i ~{vs_tss_transcripts_overlap}  -o ~{vs_tss_transcripts_overlap_base}.reorganized
        Rscript ./src/reorganize_SVID_vs_gene.R -g gene_permu/r3.gencode.v39.ensembl.105.transcript.permu_~{permu}.bed.gz -i ~{vs_partial_transcripts_overlap}  -o ~{vs_partial_transcripts_overlap_base}.reorganized
        Rscript ./src/reorganize_SVID_vs_gene.R -g gene_permu/r3.gencode.v39.ensembl.105.transcript.permu_~{permu}.bed.gz -i ~{vs_inside_exons} -o ~{vs_inside_exons_base}.reorganized
        Rscript ./src/reorganize_SVID_vs_gene.R -g gene_permu/r3.gencode.v39.ensembl.105.transcript.permu_~{permu}.bed.gz -i ~{vs_inside_introns} -o ~{vs_inside_introns_base}.reorganized
        Rscript ./src/reorganize_SVID_vs_gene.R -g gene_permu/r3.gencode.v39.ensembl.105.transcript.permu_~{permu}.bed.gz -i ~{vs_promoter} -o ~{vs_promoter_base}.reorganized
