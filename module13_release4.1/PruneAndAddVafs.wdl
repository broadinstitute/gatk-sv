...
workflow PruneAndAddVafs {
  ...
  File subset_vcf = select_first([ExtractSubsetSamples.out_vcf, vcf])
  File subset_vcf_idx = select_first([ExtractSubsetSamples.out_vcf_idx, vcf_idx])
